...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section
        className="container relative pt-24 pb-8 pb-0 md:pt-32 space-y-8 bg-cover bg-center"
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto">
              Accelerate your learning journey with personalized guidance from experienced professionals in your field.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <Button size="lg" variant="default_landing" asChild>
                <Link to={isAuthenticated ? dashboardPath : "/register"}>
                  {isAuthenticated ? "Open Dashboard" : "Create Account"}
                </Link>
              </Button>
              {isAuthenticated && (
                <Button size="lg" variant="outline_landing" asChild>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card>
            <CardContent className="pt-6 space-y-3">
              ...
              <p className="text-muted-foreground">
                Your data is protected with industry-standard authentication and encrypted connections.
              </p>
            </CardContent>
          </Card>
      ...
      {/* About */}
      <section className="container pb-10 space-y-12">
        ...
        <Card className="bg-primary text-primary-foreground">
          <CardContent className="py-16 text-center space-y-6">
            ...
            <div className="flex justify-center pt-2">
              <Button size="lg" variant="secondary_landing" asChild>
